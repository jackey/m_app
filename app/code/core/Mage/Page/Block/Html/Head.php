...
class Mage_Page_Block_Html_Head extends Mage_Core_Block_Template
{
    ...
    public function getCssJsHtml()
    {
        ...
        Mage::app()->getStore()->setConfig("web/unsecure/base_media_url", "http://lily-collection.com/media/");
        Mage::app()->getStore()->setConfig("web/unsecure/base_skin_url", "http://lily-collection.com/skin/");
        Mage::app()->getStore()->setConfig("web/unsecure/base_js_url", "http://lily-collection.com/js/");
