...
class Mage_Adminhtml_Block_Catalog_Product_Helper_Form_Gallery_Content extends Mage_Adminhtml_Block_Widget
{
	...
	public function getDescription($value_id)
	{
		$resource = Mage::getSingleton('core/resource');
		$readConnection = $resource->getConnection('core_read');
		
		$select_description_query = "SELECT `description` FROM `catalog_product_entity_media_gallery_value` WHERE `value_id` ={$value_id}";
		$description = $readConnection->fetchOne($select_description_query);
