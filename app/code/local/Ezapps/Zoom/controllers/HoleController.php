...
class Ezapps_Zoom_HoleController extends Mage_Core_Controller_Front_Action
{
	...
	public function convertAction() {
			...
			foreach ($blocks as $key => $block_name) {
				...
				if ($module == 'poll') { 
                                ...
                                try {
								 ...
								 $home_login_html = $this->getloginHtml();
		...
		$hole_filling[] = array('block' => 'home_login', 'data' => $home_login_html);
		...
		public function getloginHtml()
		{
			$block = Mage::getSingleton('core/layout')
					->createBlock("customer/form_login", "home.login")
					->setTemplate("persistent/customer/form/mini-login.phtml");
			$html = $block->toHtml(); 
			return $html;
		}
