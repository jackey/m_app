                ...
                url,
                {
                    ...
                    onComplete: function (xhr)
                    {
                        ...
                        $$('.number').each(function (el){
                            el.innerHTML = parseInt(link_cart_txt);
                        });
                        //add by xavi
...
function cartdelete(url){
    ...
    url,
    {
        ...
        onComplete: function (xhr)
        {
            ...
            $$('.top-link-cart').each(function (el){
                el.innerHTML = parseInt(cart_content);
            });
            //add by xavi
            $$('.number').each(function (el){
...
function showConfirm(){
    ...
    if(jQuery(window).width()<640){
        confirm_box.style.width = 300 + 'px';
        confirm_box.style.height = 400 + 'px';
    }else{
    ...
    if (j2t_show_close){
        ...
        Event.observe($('j2t-closing-button'), 'click', hideJ2tOverlay);
    }
