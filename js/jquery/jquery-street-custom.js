...
jQuery(document).ready(function($){
	...
	$(window).scroll(function() {
		...
		street_style4_elementOffset_2 = $('.street-style4:eq(1)').offset().top,
			street_style4_distance_2 = 0.05*(street_style4_elementOffset_2 - diff),
		street_style4_elementOffset_3 = $('.street-style4:eq(2)').offset().top,
			street_style4_distance_3 = 0.05*(street_style4_elementOffset_3 - diff),
		...
		street_style5_elementOffset_2 = $('.street-style5:eq(1)').offset().top,
			street_style5_distance_2 = 0.1*(street_style5_elementOffset_2 - diff);
		/*move left*/
		...
		if(street_style5_distance_2 < 50 && street_style5_distance_2 > -100){
			//console.log(street_style5_distance_1);
			//console.log($('.street-style3 img.move'));
			//$('.street-style3 img.moves-left').css('margin-left',-100 - street_style5_distance_1);
			$('.street-style5.street-style2-2 img.zoom').css('width',1060 + street_style5_distance_2);
		}
		...
		if(street_style4_distance_2 < 50 && street_style4_distance_2 > -20){
			//console.log(trend1_distance);
			$('.street-style4.street-style2-1 img.moves-right').css('margin-left',-50+ street_style4_distance_2 );
			$('.street-style4.street-style2-1 img.moves-left').css('margin-left',-50 - 1.5*street_style4_distance_2);
		}
		if(street_style4_distance_3 < 50 && street_style4_distance_3 > -20){
			//console.log(trend1_distance);
			$('.street-style4.street-style2-3 img.moves-right').css('margin-left',-50+ street_style4_distance_3 );
			$('.street-style4.street-style2-3 img.moves-left').css('margin-left',-50 - 1.5*street_style4_distance_3);
		}
